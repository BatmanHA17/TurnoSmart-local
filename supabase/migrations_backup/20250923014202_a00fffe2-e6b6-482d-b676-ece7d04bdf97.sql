-- Insertar todas las categorías profesionales del convenio de Las Palmas

-- Completar las categorías del NIVEL I
...
-- Insertar categorías del NIVEL II
INSERT INTO public.professional_categories (category_name, level_id, description, agreement_id, org_id, created_by, category_type)
SELECT 
    categoria,
...
-- Insertar categorías del NIVEL III
INSERT INTO public.professional_categories (category_name, level_id, description, agreement_id, org_id, created_by, category_type)
SELECT 
    categoria,
...
-- Insertar categorías del NIVEL IV
INSERT INTO public.professional_categories (category_name, level_id, description, agreement_id, org_id, created_by, category_type)
SELECT 
    categoria,
...
-- Insertar la categoría del NIVEL IV BIS
INSERT INTO public.professional_categories (category_name, level_id, description, agreement_id, org_id, created_by, category_type)
VALUES 
...
-- Insertar categorías del NIVEL V
INSERT INTO public.professional_categories (category_name, level_id, description, agreement_id, org_id, created_by, category_type)
SELECT 
    categoria,
