-- Ajustar la estructura de professional_categories para permitir niveles sin convenio específico
-- y limpiar datos existentes para insertar los correctos
...
-- Hacer que agreement_id sea nullable para permitir categorías generales
ALTER TABLE public.professional_categories 
ALTER COLUMN agreement_id DROP NOT NULL;

-- Hacer que org_id y category_type sean nullable para categorías generales
ALTER TABLE public.professional_categories 
...
-- Insertar los niveles profesionales correctos del convenio de Las Palmas
