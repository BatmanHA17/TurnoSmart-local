...
WHERE id = 'cd2140c0-179d-4368-9195-610dafb2e291'::uuid;
...
('cd2140c0-179d-4368-9195-610dafb2e291'::uuid, 'ae3db3e5-00ec-43c3-a3de-a245de33729d'::uuid, 'GRUPO_I', 'Personal Directivo', 'Gerentes, directores y personal de alta dirección', 1),
('cd2140c0-179d-4368-9195-610dafb2e291'::uuid, 'ae3db3e5-00ec-43c3-a3de-a245de33729d'::uuid, 'GRUPO_II', 'Personal Técnico Superior', 'Técnicos superiores, jefes de departamento y especialistas', 2),
('cd2140c0-179d-4368-9195-610dafb2e291'::uuid, 'ae3db3e5-00ec-43c3-a3de-a245de33729d'::uuid, 'GRUPO_III', 'Personal Cualificado', 'Empleados con formación específica y experiencia', 3);

-- Insertar niveles salariales de prueba asociados a los grupos
WITH groups_data AS (
  SELECT id, group_code FROM professional_groups 
  WHERE agreement_id = 'cd2140c0-179d-4368-9195-610dafb2e291'::uuid
)
...
SELECT 
  'cd2140c0-179d-4368-9195-610dafb2e291'::uuid,
  'ae3db3e5-00ec-43c3-a3de-a245de33729d'::uuid,
  g.id,
