-- Corregir permisos específicos para cada rol usando los nombres correctos de la tabla permissions
...
('director', 'anular_validacion_horas', true, true),
...
('director', 'eliminar_perfil_empleado', false, true),
...
('manager', 'editar_planificaciones_publicadas', false, true),
