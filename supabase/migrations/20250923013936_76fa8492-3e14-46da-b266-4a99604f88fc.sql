-- Hacer que agreement_id sea realmente nullable y luego insertar los datos
-- Primero forzar que la columna sea nullable

-- Eliminar datos existentes
DELETE FROM public.professional_categories;
DELETE FROM public.professional_levels;

-- Forzar que agreement_id sea nullable
...
-- Insertar una muestra de categorías para verificar que funciona
