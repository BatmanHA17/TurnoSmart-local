...
// Datos de ejemplo extraídos del tutorial Scribe
...
export function EntradasTable({ empleados = empleadosEjemplo, onEmpleadoClick, className }: EntradasTableProps) {
          ...
          <TableRow className="bg-gray-50/50 hover:bg-gray-50/80">
            <TableHead className="font-medium text-gray-700">
              <Button
                ...
                onClick={() => handleSort("fechaLlegada")}
              >
                {esStrings.fechaDeLlegada}
