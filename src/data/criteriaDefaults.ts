/**
 * TurnoSmart® — Catálogo completo de 98 criterios SMART
 *
 * Fuente: TurnoSmart_Criterios_SMART.xlsx (4 hojas) + análisis cuadrante real Abril 2026
 * 18 Obligatorios (OB) + 43 Opcionales (OP) + 27 Checks (CK) + 10 SMART+IA (SM)
 */
...
export interface CriteriaDefault {
  ...
  defaultBoost: number; // 1-3 (1=Normal, 2=Moderado, 3=Enfatizado)
...
export const OBLIGATORIOS: CriteriaDefault[] = [
  ...
  },
  {
    ...
    description: "Máximo horas semanales según tipo de contrato (40/35/30/25/20h). Futura reforma 37.5h para jornada completa",
  ...
  {
    code: "OB-12", key: "WEEKLY_REST_EXCEPTIONS",
    name: "Excepciones descanso semanal (picos de trabajo)",
    description: "En picos de trabajo, los 2 días consecutivos pueden reducirse a 1 día. Máximo 3 semanas consecutivas y 9 veces/año. Requiere validación manager + alerta empleado",
    category: "mandatory", subcategory: "Legal", severity: "error",
    defaultEnabled: true, defaultBoost: 3,
  },
  {
  ...
  },
  {
    ...
    description: "FOM en M → AFOM en T. FOM libra → AFOM cubre. FOM en G → AFOM libra. AFOM puede hacer N cuando la lógica de generación lo requiera. Cálculo secuencial",
    category: "mandatory", subcategory: "Organización", severity: "error",
    defaultEnabled: true, defaultBoost: 3,
  },
  {
    code: "OB-17", key: "NIGHT_COVERAGE_EQUITY",
    name: "Cobertura noches Night Agent por rotación estricta de antigüedad",
    description: "Cuando Night Agent libra, las noches las cubren los FDAs en orden estricto de antigüedad (round-robin): FDA#1 sem1, FDA#2 sem2, etc. Tras cubrir noches: 2D consecutivos. Sin compensación DB. El motor lee cuadrantes anteriores para continuar la rotación",
...
export const OPCIONALES: CriteriaDefault[] = [
  ...
  },
  {
    ...
    description: "Mismo número de noches (±2 tolerancia) para todos los rotativos al año. Night Agent fijo excluido",
    category: "optional", subcategory: "Equidad", severity: "warning",
    defaultEnabled: true, defaultBoost: 3,
  },
  {
  ...
  },
  {
    ...
    description: "Preferencias tipo 'prefiero librar miércoles'. Peso: 1=Deseo (intenta pero no prioriza), 2=Crítico (casi obligatorio). Manager valida",
  ...
  },
  {
    ...
    defaultEnabled: true, defaultBoost: 2,
    configJson: { maxNights: 2, minNights: 1, maxConfigurable: 6 },
  },
  {
  ...
  },
  {
    ...
    category: "optional", subcategory: "Configuración", severity: "info",
    defaultEnabled: false, defaultBoost: 1,
  },
  {
  ...
  },
  {
    ...
    category: "optional", subcategory: "Ergonomía", severity: "warning",
    defaultEnabled: true, defaultBoost: 2,
    configJson: { threshold: 2, min: 1, max: 6 },
  },
  {
  ...
  {
    code: "OP-40", key: "HOLIDAY_CALENDAR_NATIONAL_REGIONAL",
    name: "Calendario festivos nacional + regional",
    description: "El motor conoce los festivos nacionales del país y los regionales/provinciales del convenio colectivo. Se cargan automáticamente y determinan cuándo se generan F y compensatorios",
    category: "optional", subcategory: "Legal", severity: "warning",
    defaultEnabled: true, defaultBoost: 3,
    configJson: { country: "ES", province: "Cádiz", sector: "hostelería" },
  },
  {
    code: "OP-41", key: "VACATION_REST_ENTRY_EXIT",
    name: "Vacaciones: salir/entrar con descansos",
    description: "Toggle por empleado: 'Salir a vacaciones con mis 2 días de descanso' (D antes de V) o 'Entrar de vacaciones con mis 2 días de descanso' (D después de V). Configurable individualmente",
    category: "optional", subcategory: "Preferencias", severity: "info",
    defaultEnabled: true, defaultBoost: 2,
    configJson: { mode: "exit_with_rest", options: ["exit_with_rest", "enter_with_rest"] },
  },
  {
    code: "OP-42", key: "CAN_COVER_NIGHTS_FLAG",
    name: "Exclusión empleado de rotación nocturna",
    description: "Flag por empleado (canCoverNights). Si es false, ese FDA se excluye de la rotación de cobertura de noches del Night Agent. Default: true para todos los ROTA_COMPLETO",
    category: "optional", subcategory: "Configuración", severity: "info",
    defaultEnabled: true, defaultBoost: 2,
  },
  {
    code: "OP-43", key: "DB_DG_ENJOY_PROMPT",
    name: "Sugerencia disfrute días debidos (DB/DG)",
    description: "El motor analiza el saldo de días debidos del empleado y sugiere: 'Tienes X días debidos (X por guardias, X por festivos, X por semanas de 6 días). ¿Quieres colocarlos esta semana?'",
    category: "optional", subcategory: "IA proactiva", severity: "info",
    defaultEnabled: true, defaultBoost: 2,
  },
];
...
export const CHECKS: CriteriaDefault[] = [
  ...
  {
    code: "CK-26", key: "CHECK_VACATION_ANNUAL_RATIO",
    name: "Ratio vacaciones anual ≥90% al 31/dic",
    description: "Verificar proyección: cada empleado debe llegar al 31 de diciembre con ≥90% de sus vacaciones disfrutadas. Alerta si el ritmo actual no lo permite",
    category: "check", subcategory: "Post-gen", severity: "warning",
    defaultEnabled: true, defaultBoost: 2,
    configJson: { minRatio: 0.9, projectionMonth: 12 },
  },
  {
    code: "CK-27", key: "CHECK_NIGHT_ROTATION_CONTINUITY",
    name: "Continuidad rotación nocturna cross-período",
    description: "Verificar que la rotación de cobertura nocturna continúa donde quedó en el cuadrante anterior. Leer último FDA que cubrió y continuar con el siguiente en antigüedad",
    category: "check", subcategory: "Pre-gen", severity: "error",
    defaultEnabled: true, defaultBoost: 3,
  },
];
