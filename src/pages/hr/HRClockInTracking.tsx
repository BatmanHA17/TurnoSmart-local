...
import { ClockInTrackingTable, type SeguimientoFichaje } from "@/components/clock-in-tracking/ClockInTrackingTable";
...
export default function HRClockInTracking() {
  ...
  useEffect(() => {
    document.title = "Seguimiento de fichajes – TurnoSmart";
  }, []);
      ...
      <div className="flex min-h-screen bg-muted/20">
        ...
        <div className="flex-1 p-6">
          <div className="max-w-7xl mx-auto">
            ...
            {/* Tabla de seguimiento de fichajes */}
            <ClockInTrackingTable
              fichajes={[]} // Se usarán los datos de ejemplo del componente
