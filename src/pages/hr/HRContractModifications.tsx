...
import { ContractModificationsTable, type ModificacionContrato } from "@/components/contract-modifications/ContractModificationsTable";
...
export default function HRContractModifications() {
  ...
  useEffect(() => {
    document.title = "HR Modificación de Contratos – TurnoSmart";
  }, []);
      ...
      <div className="flex min-h-screen bg-muted/20">
        ...
        <div className="flex-1 p-6">
          <div className="max-w-7xl mx-auto">
            ...
            {/* Tabla de modificaciones de contratos */}
            <ContractModificationsTable
              modificaciones={[]} // Se usarán los datos de ejemplo del componente
