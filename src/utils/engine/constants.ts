...
export const SHIFT_TIMES: Record<string, ShiftTime> = {
  ...
  "11x19": { code: "11x19", startTime: "11:00", endTime: "19:00", hours: 8, label: "11h a 19h" },
  "9x17":  { code: "9x17",  startTime: "09:00", endTime: "17:00", hours: 8, label: "9h a 17h" },
  "12x20": { code: "12x20", startTime: "12:00", endTime: "20:00", hours: 8, label: "12h a 20h" },
